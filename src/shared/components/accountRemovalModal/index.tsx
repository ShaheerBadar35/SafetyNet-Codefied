...
const AccountRemovalModal = ({
  ...
  onPressBtn = () => {},
  alertContainerStyle,
}: Partial<AccountRemovalModalProps>) => {
  return (
    <>
          ...
          <View style={styles.blurSubCon}>
            <View style={[styles.alertCon, alertContainerStyle]}>
              ...
              <CustomText
                ...
                You have been removed as a user from a Safety Net Family Plan.
                To continue using Safety Net’s features please select a new
                plan.
              </CustomText>
              <CustomButton
