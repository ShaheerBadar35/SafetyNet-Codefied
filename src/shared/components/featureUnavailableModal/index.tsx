...
const FeatureUnavailableModal = ({
  open,
  onPressClose = () => {},
  onPressBtn = () => {},
  isChild = false,
  alertContainerStyle,
}: Partial<FeatureUnavailableModalProps>) => {
  return (
    <>
          ...
          <View style={styles.blurSubCon}>
            <View style={[styles.alertCon, alertContainerStyle]}>
              ...
              <CustomText
                ...
                {isChild
                  ? 'You do not have access to these settings. To make changes, please contact your family plain administrator.'
                  : 'This feature is only available in family plan.'}
              </CustomText>
              {!isChild && (
                <CustomButton
