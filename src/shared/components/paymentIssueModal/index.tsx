...
const PaymentIssueModal = ({
  open,
  onPressClose = () => {},
  onPressBtn = () => {},
  alertContainerStyle,
}: Partial<PaymentIssueModalProps>) => {
  return (
    <>
          ...
          <View style={styles.blurSubCon}>
            <View style={[styles.alertCon, alertContainerStyle]}>
              ...
              <CustomText
                ...
                There was an issue with charging your card. Please check your
                car details for Google Play and try again.
              </CustomText>
              <CustomButton
                title="Done"
                titleSize={18}
