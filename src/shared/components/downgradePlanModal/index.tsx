...
const DowngradePlanModal = ({
  ...
  onPress = () => {},
  alertContainerStyle,
}: Partial<DowngradePlanModalProps>) => {
  return (
    <>
        ...
        <BlurView
          ...
          <View style={styles.blurSubCon}>
            <View style={[styles.alertCon, alertContainerStyle]}>
              ...
              <NestedText2
                text={'Your plan has been downgraded from'}
                size={10}
                ...
                N4text={
                  'You still have access to your family plan features until the end of your current billing cycle then your will be automatically switched to the single plan.'
                }
                N4size={10}
