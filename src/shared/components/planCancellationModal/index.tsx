...
const PlanCancellationModal = ({
  open,
  onPressClose = () => {},
  onPressBtn = () => {},
  isLoading = false,
  alertContainerStyle,
}: Partial<PlanCancellationModalProps>) => {
  return (
    <>
          ...
          <View style={styles.blurSubCon}>
            <View style={[styles.alertCon, alertContainerStyle]}>
              ...
              <CustomText
                ...
                If you cancel your plan, you will not have access to any
                functions of Safety Net after your current billing cycles.
              </CustomText>
              <CustomButton
                title="Confirm"
                titleSize={18}
