    ...
    <Wrapper noPaddingBottom>
      <View style={styles.contianer}>
        ...
        <ScrollView style={styles.scrollCon}>
          ...
          <CustomText
            ...
            In the Assistant settings you’ve just opened:
          </CustomText>
          <NestedText2
            size={10}
            fontFamily={INTER.REGULAR}
            ...
            N2text={
              '(it may be listed under ‘Popular Settings’).Turn on the ‘Hey Google’ switch to start the Voice Match setup.'
            }
            N2size={10}
          ...
          <NestedText2
            ...
            Ncolor={COLORS.LIGHT_BLACK}
            Nstyle={{lineHeight: RF(16)}}
            N2text={'witch to start the Voice Match setup.'}
            N2size={10}
            N2fontFamily={INTER.REGULAR}
            N2color={COLORS.LIGHT_BLACK}
            N2style={{lineHeight: RF(16)}}
          ...
          <NestedText2
            ...
            color={COLORS.LIGHT_BLACK}
            style={{lineHeight: RF(16)}}
            text={'3. Follow the on-screen steps and say  '}
            Ntext={'‘Hey Google’ '}
            Nsize={10}
            NfontFamily={INTER.BOLD}
            Ncolor={COLORS.LIGHT_BLACK}
            Nstyle={{lineHeight: RF(16)}}
            N2text={'a few times so Assistant learns your voice.'}
            N2size={10}
            N2fontFamily={INTER.REGULAR}
            N2color={COLORS.LIGHT_BLACK}
            N2style={{lineHeight: RF(16)}}
          ...
          <CustomText
            ...
            After Voice Match is set up, come back to SafetyNet.
          </CustomText>
        </ScrollView>
        <CustomIcon
      ...
      <View
        ...
        <CustomButton
          ...
          titleStyle={{lineHeight: RF(16)}}
          customStyle={{...SPACING.py2, ...SPACING.px4}}
          onPress={() => navigate(ROUTES.ASSISTANT_SCREEN)}
        />
      </View>
    </Wrapper>
  );
